...
/**
 * The test of {@link OrikaAutoConfiguration} when {@link MapperFactoryBuilder} is customized.
 */
@RunWith(SpringRunner.class)
@SpringBootTest
public class OrikaAutoConfigurationMapperFactoryBuilderCustomizedTest {
